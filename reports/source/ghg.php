...
<head>
    ...
    <title>CO2 Calculator - GHG</title>
</head>
<body>
        ...
        <div class="panel-container">
                <div class="container">
                    <div class="instructions">
                        <h2><a class="return" href="/reports"> <iconify-icon icon="fa6-solid:arrow-left" width="20"></iconify-icon> </a> GHG Protocol</h2>
                        <p>Visualize o seu inventário de emissões no formato do registro público de emissões do Programa Brasileiro do GHG Protocol. O relatório apresenta todos os campos necessários, exceto os que devem ser preenchidos exclusivamente pela sua organização, como estratégias e ações internas.</p>
                    </div>
                    <div class="filters">
                        <span>Filtros</span>
                        <div class="filter">
                        ...
                        <div class="filter">
                            <iconify-icon icon="ph:shopping-bag-duotone"></iconify-icon>
                            <span>Clientes</span>
                            <iconify-icon icon="ep:arrow-down-bold" width="10"></iconify-icon>
                        </div>
                        <div class="filter">
                            <iconify-icon icon="fluent:building-shop-20-filled"></iconify-icon>
