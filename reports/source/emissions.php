...
<head>
    ...
    <title>CO2 Calculator - Emissões fugitivas</title>
</head>
<body>
        ...
        <div class="panel-container">
                <div class="container">
                    <div class="instructions">
                        <h2><a class="return" href="/reports"> <iconify-icon icon="fa6-solid:arrow-left" width="20"></iconify-icon> </a> Emissões fugitivas</h2>
