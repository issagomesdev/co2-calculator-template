...
<head>
    ...
    <title>CO2 Calculator - Combustível</title>
</head>
<body>
        ...
        <div class="panel-container">
                <div class="container">
                    <div class="instructions">
                        <h2><a class="return" href="/reports"> <iconify-icon icon="fa6-solid:arrow-left" width="20"></iconify-icon> </a> Combustível</h2>
...
<script>
    ...
    new Chart(all, {
        type: 'bar',
        data: {
            labels: ['Emissões', 'xx', 'ww'],
            datasets: [{
                label: 'tonCO2e',
                data: [0.012, 0.010, 0.02],
