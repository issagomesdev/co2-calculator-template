...
<head>
    ...
    <title>CO2 Calculator - Configurar medições </title>
</head>
<body>
    ...
    <div class="content">
        ...
        <div class="panel-container">
            <div class="select-emissions-source">
                <div class="container">
                    <div class="info">
                        <h3>Configurações das medições</h3>
                        <p>Informe para cada fonte de emissão como sua empresa funciona e os dados que ela tem disponível. As suas respostas definirão quais dados serão coletados na medição de emissões e com que frequência.</p>
                    </div>
                    <div class="selection">
