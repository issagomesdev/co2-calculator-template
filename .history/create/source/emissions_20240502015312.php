            ...
            <div class="columns" id="gas">
                <div class="column" style="width: 11em;">
                    <select>
                        ...
                        <option value="R134a">Óxido nitroso (N2O)</option>
                        <option value="R600a">Óxido nitroso (N2O)</option>
                        <option value="R290">Óxido nitroso (N2O)</option>
                        <option value="R404A">Óxido nitroso (N2O)</option>
                        <option value="R507A">Óxido nitroso (N2O)</option>
                        <option value="R717">Óxido nitroso (N2O)</option>
                        <option value="R452A">Óxido nitroso (N2O)</option>
                        <option value="R744">Óxido nitroso (N2O)</option>
                        <option value="R22">Óxido nitroso (N2O)</option>
                        <option value="R123">Óxido nitroso (N2O)</option>
                        <option value="R410A">Óxido nitroso (N2O)</option>
                        <option value="R32">Óxido nitroso (N2O)</option>
                        <option value="R1234yf">Óxido nitroso (N2O)</option>
                        <option value="HFC-227ea">Óxido nitroso (N2O)</option>
                        <option value="HFC-236fa">Óxido nitroso (N2O)</option>
                        <option value="HFC-125">Óxido nitroso (N2O)</option>
                    </select>
                </div>
            </div>
